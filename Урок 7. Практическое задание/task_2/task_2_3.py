...
Т.к., во-первых, они работают быстрее. Во-вторых, скорее всего в них исправлены недочеты,
которые мы можем не заметить при написании. И не нужно тратить много времени на создание функции.
"""
